...
LDLIBSOPTIONS=-lcomedi -lm `pkg-config --libs x11` `pkg-config --libs xaw7`  
...
${OBJECTDIR}/_ext/1472/bmc.o: ../bmc.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags x11` `pkg-config --cflags xaw7`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/bmc.o ../bmc.c

${OBJECTDIR}/daq.o: daq.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags x11` `pkg-config --cflags xaw7`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/daq.o daq.c
